...
const Header = (props) => {
    ...
    return (
        <header className="header-component row w-100">
            ...
            <div className='col-3 d-flex justify-content-end align-items-center'>
                <a onClick={handleNavLink} className='btn btn-outline-light d-flex align-items-center justify-content-center' style={{ height: '50%' }}>
